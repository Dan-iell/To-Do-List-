...
buttontdl.addEventListener("click", (e) => {
  ...
  // }
  // else {
  //   console.log("money pressed successfully");
  // }
  const itemall = document.createElement("div");
  itemall.classList.add("itemall"); // add 'item' class to div

  const item = document.createElement("p"); //create a new paragraph for
